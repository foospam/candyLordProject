...
public enum ScreenName {
    ...
    WELCOME_SCREEN,
    MAIN_SELECTION,
    SELECT_DRUG_TO_BUY, SELECT_QTY_TO_BUY, HOLD_EXCEEDED, CASH_EXCEEDED, ZERO_STUFF_TO_BUY,
    SELECT_DRUG_TO_SELL, SELECT_QTY_TO_SELL, STASH_EXCEEDED, ZERO_STUFF_TO_SELL,
