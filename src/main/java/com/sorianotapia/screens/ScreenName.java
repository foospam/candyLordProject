...
public enum ScreenName {
    ...
    WELCOME_SCREEN,
    MAIN_SELECTION,
    SELECT_STUFF_TO_BUY, SELECT_QTY_TO_BUY, HOLD_EXCEEDED, CASH_EXCEEDED, ZERO_STUFF_TO_BUY,
    SELECT_STUFF_TO_SELL, SELECT_QTY_TO_SELL, STASH_EXCEEDED, ZERO_STUFF_TO_SELL,
    ...
    ROB_MONEY, ROB_ALL_MONEY, ROB_ALL_MONEY_NO_OK,
    ROB_STUFF, ROB_ALL_STUFF, ROB_ALL_STUFF_NO_OK,
    BUY_STUFF_CARRIER, BUY_STUFF_CARRIER_OK, BUY_STUFF_CARRIER_NO,
    BUY_ARM, BUY_ARM_OK, BUY_ARM_NO_OK, NO_MONEY,
    RECLAIM_DEBT, HIT_DEBITOR, WARN_DEBITOR, GAME_OVER, GOOD_BYE, NEW_GAME, EVENT_LOOP,
    SET_COMBAT, COMBAT_ACTION_SELECTION, COMBAT_RESULT,
    QUIT_CONFIRMATION;
}
